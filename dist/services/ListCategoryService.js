...
var ListCategoryService = /** @class */ (function () {
    ...
    ListCategoryService.prototype.execute = function (_a) {
        var wallet_id = _a.wallet_id;
        return __awaiter(this, void 0, void 0, function () {
            var categoriesRepository, walletsRepository, existsWallet;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, categoriesRepository.find({ where: { wallet_id: wallet_id } })];
                }
            });
        });
    };
