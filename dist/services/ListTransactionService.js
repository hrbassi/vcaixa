...
var ListTransactionService = /** @class */ (function () {
    function ListTransactionService() {
    }
    ListTransactionService.prototype.execute = function (_a) {
        var wallet_id = _a.wallet_id;
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, walletsRepository, existsWallet;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, transactionsRepository.find({
...
exports.default = ListTransactionService;
