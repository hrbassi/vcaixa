...
var ListCategoryService_1 = __importDefault(require("../services/ListCategoryService"));
...
categoriesRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var wallet_id, name_1, createCategory, category, err_1;
...
categoriesRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var wallet_id, listCategory, category, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                wallet_id = request.headers.wallet_id;
                listCategory = new ListCategoryService_1.default();
                return [4 /*yield*/, listCategory.execute({
                        wallet_id: wallet_id,
                    })];
            case 1:
                category = _a.sent();
