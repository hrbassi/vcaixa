...
var ListTransactionService_1 = __importDefault(require("../services/ListTransactionService"));
...
transactionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var wallet_id, _a, date, category_id, type, value, description, createTransaction, transaction, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                wallet_id = request.headers.wallet_id;
                _a = request.body, date = _a.date, category_id = _a.category_id, type = _a.type, value = _a.value, description = _a.description;
...
transactionsRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var wallet_id, listTransaction, transaction, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                wallet_id = request.headers.wallet_id;
                listTransaction = new ListTransactionService_1.default();
                return [4 /*yield*/, listTransaction.execute({
                        wallet_id: wallet_id,
                    })];
            case 1:
                transaction = _a.sent();
